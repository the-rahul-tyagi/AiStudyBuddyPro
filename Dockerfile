...
# 3. PREVENT INTERACTIVE PROMPTS (This fixes the Jenkins hang!)
ENV DEBIAN_FRONTEND=noninteractive

# 4. Install system dependencies required for pdfkit
...
# 7. Create a non-root user and grant permissions to the app directory
...
# 9. Command to run the Streamlit application
